...
namespace Paw.Services.Messages.Web.Providers
{
    public class GetProvider
    {
        ...
        public Provider ExecuteItem()
        {
            return this.ExecuteItem(false);
        }
        ...
        public Provider ExecuteItem(bool useCache = true)
        {
            ...
            using (DataContext dataContext = DataContext.CreateForMessage(this))
            {
                Provider result = dataContext
                    ...
                    .Include(x => x.SkuCategoryCollection)
                    .Include(x => x.SkuCollection)
                    .Include("SkuGroupCollection.SkuGroupSkuCollection")
        ...
        public Provider ExecuteItemCore()
        {
            using (DataContext dataContext = DataContext.CreateForMessage(this))
            {
                Provider result = dataContext
