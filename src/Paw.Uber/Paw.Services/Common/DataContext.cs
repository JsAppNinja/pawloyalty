...
namespace Paw.Services.Common
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<ColorMarking> ColorMarkingSet { get; set; }
        ...
        public DbSet<PetNote> PetNoteSet { get; set; }

        public DbSet<PetNoteCategory> PetNoteCategorySet { get; set; }
        ...
        public DbSet<ReferredBy> ReferredBySet { get; set; }

        public DbSet<ReservationGroup> ReservationGroupSet { get; set; }
        ...
        public DbSet<SkuGroup> SkuGroupSet { get; set; }

        public DbSet<SkuGroupSku> SkuGroupSkuSet { get; set; }

        public DbSet<SkuLine> SkuLineSet { get; set; }

        public DbSet<Sku> SkuSet { get; set; }

        public DbSet<TagPet> TagPetSet { get; set; }

        public DbSet<Tag> TagSet { get; set; }

        public DbSet<TagTarget> TagTargetSet { get; set; }
        ...
        public DbSet<Vet> VetSet { get; set; }
        ...
        public override int SaveChanges()
        {
            ...
            foreach (var entry in this.ChangeTracker.Entries())
            {
                switch (entry.State)
                {
                    case System.Data.Entity.EntityState.Added:
                        this.Added(entry.Entity, timestamp);
                        break;
                    case System.Data.Entity.EntityState.Deleted:
                        this.Deleted(entry.Entity, timestamp);
                        break;
                    case System.Data.Entity.EntityState.Detached:
                        break;
                    case System.Data.Entity.EntityState.Modified:
                        this.Modified(entry.Entity, timestamp);
                        break;
            ...
            // var exList = this.GetValidationErrors().ToList();
        ...
        public void Added(object added, DateTime timestamp)
        {
            ...
            CacheHelper2.Notify(added, this.Message, CacheActionTypes.Insert);
        }
        ...
        public static DataContext Create(Guid? userId)
        {
            return new DataContext() { CurrentUserId = userId ?? IdentityHelper.GetCurrentUserId() };
        }

        public static DataContext CreateForMessage(object message, Guid? userId = null)
        {
            // TODO: When creating the data context, cast message and pull properties

            return new DataContext() { CurrentUserId = userId ?? IdentityHelper.GetCurrentUserId(), Message = message };
        }
