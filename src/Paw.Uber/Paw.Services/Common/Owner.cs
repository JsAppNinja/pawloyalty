...
namespace Paw.Services.Common
{
    public class Owner : IId, IProviderGroupId, IAudit
    {
        ...
        public DateTime?  WaiverSigned
        {
            get { return _WaiverSigned; }
            set { _WaiverSigned = value; }
        }
        private DateTime? _WaiverSigned = null;

        public DateTime? WaiverExpiration
        {
            get { return _WaiverExpiration; }
            set { _WaiverExpiration = value; }
        }
        private DateTime? _WaiverExpiration = null;

        public Guid? ReferredById
        {
            get { return _ReferredById; }
            set { _ReferredById = value; }
        }
        private Guid? _ReferredById = null;
