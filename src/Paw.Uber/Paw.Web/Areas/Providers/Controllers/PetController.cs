...
{
    public class PetController : AuthorizeController
    {
        ...
        public ActionResult Profile(Guid providerId, GetPet getPet)
        {
            ...
            List<Reservation> reservationList = new GetReservationListByPetId() { PetId = getPet.Id, ProviderId = providerId }.ExecuteList();
